...
vim.keymap.set('n', '<leader>fo', require('telescope.builtin').grep_string, { desc = '[F]ind current w[O]rd' })
vim.keymap.set('n', '<leader>fw', require('telescope.builtin').live_grep, { desc = '[F]ind by grep [w]' })
